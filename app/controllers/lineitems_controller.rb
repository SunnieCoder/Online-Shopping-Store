class LineitemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @lineitem.save
        format.html { redirect_to shopper_url, notice: "Product was successfully created." }
        format.js
  ...
  def update
    respond_to do |format|
      if @lineitem.update(lineitem_params)
        format.html { redirect_to lineitem_url(@lineitem), notice: "Item was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to lineitems_url, notice: "Item was successfully deleted." }
